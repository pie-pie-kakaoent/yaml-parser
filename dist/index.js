...
exports.flattenFromYamlFile = void 0;
const yaml = __importStar(__nccwpck_require__(1917));
const flat_1 = __nccwpck_require__(9681);
const promises_1 = __nccwpck_require__(9225);
function flattenFromYamlFile(filename) {
    return __awaiter(this, void 0, void 0, function* () {
        const rawData = yield (0, promises_1.readFile)(filename, 'utf8');
        const yamlObject = yaml.load(rawData);
        return (0, flat_1.flatten)(yamlObject, { delimiter: '_' });
    });
}
exports.flattenFromYamlFile = flattenFromYamlFile;
...
const flatten_1 = __nccwpck_require__(2354);
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const filename = core.getInput('filename', { required: true });
            const flattenObject = yield (0, flatten_1.flattenFromYamlFile)(filename);
            Object.entries(flattenObject).forEach(([key, value]) => core.setOutput(key, value));
        }
        catch (error) {
